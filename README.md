...
- [Tổng quan](#tổng-quan)
- [Cách khai báo enum](#cách-khai-báo-enum)
- [Sử dụng enum](#sử-dụng-enum)
- [Ưu điểm của enum](#ưu-điểm-của-enum)
- [Ứng dụng của enum](#ứng-dụng-của-enum)
